 ...
 */
export function BanorteMark({ className = "block h-9 w-auto shrink-0", tone = "red" }: { className?: string; tone?: "red" | "white" }) {
  return (
    <svg
      ...
      className={className}
    >
      <g fill={tone === "white" ? "#FFFFFF" : "#EC1C2D"} transform="matrix(3.2,0,0,3.2,-65.6,-911.04)">
